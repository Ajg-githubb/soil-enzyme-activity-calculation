#soil enzyme #protocol #from excel to R #jacob_30 samples_4controls
#clear memory
rm(list = ls())
...
data <- read.csv("C:/Users/ayush/Dropbox/Ayush/enzyme study/jacob/R/input_csv/JPRER3_12-32-19.1.csv")
...
#sample 31
s31_bgluc <- data [c(271:278), c(2:3)]
s31_bgluc <- rbind (s31_bgluc$b.gluc, s31_bgluc$b.gluc.1)
s31_nag <- data [c(271:278), c(4:5)]
s31_nag <- rbind (s31_nag$NAG, s31_nag$NAG.1)
s31_phos <- data [c(271:278), c(6:7)]
s31_phos <- rbind (s31_phos$Phos, s31_phos$Phos.1)
s31_hr1_coef_emis_10 <- data[c(271:278),8]
s31_hr1_coef_emis_25 <- data[c(271:278),9]
s31_hr1_coef_emis_50 <- data[c(271:278),10]
s31_hr1_coef_emis_100 <- data[c(271:278),11]
s31_hr1_homogenate_blank <- data [c(271:278), c(12:13)]
s31_hr1_homogenate_blank <- rbind(s31_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK, s31_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK.1)

#sample 32
s32_bgluc <- data [c(280:287), c(2:3)]
s32_bgluc <- rbind (s32_bgluc$b.gluc, s32_bgluc$b.gluc.1)
s32_nag <- data [c(280:287), c(4:5)]
s32_nag <- rbind (s32_nag$NAG, s32_nag$NAG.1)
s32_phos <- data [c(280:287), c(6:7)]
s32_phos <- rbind (s32_phos$Phos, s32_phos$Phos.1)
s32_hr1_coef_emis_10 <- data[c(280:287),8]
s32_hr1_coef_emis_25 <- data[c(280:287),9]
s32_hr1_coef_emis_50 <- data[c(280:287),10]
s32_hr1_coef_emis_100 <- data[c(280:287),11]
s32_hr1_homogenate_blank <- data [c(280:287), c(12:13)]
s32_hr1_homogenate_blank <- rbind(s32_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK, s32_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK.1)

#sample 33
s33_bgluc <- data [c(289:296), c(2:3)]
s33_bgluc <- rbind (s33_bgluc$b.gluc, s33_bgluc$b.gluc.1)
s33_nag <- data [c(289:296), c(4:5)]
s33_nag <- rbind (s33_nag$NAG, s33_nag$NAG.1)
s33_phos <- data [c(289:296), c(6:7)]
s33_phos <- rbind (s33_phos$Phos, s33_phos$Phos.1)
s33_hr1_coef_emis_10 <- data[c(289:296),8]
s33_hr1_coef_emis_25 <- data[c(289:296),9]
s33_hr1_coef_emis_50 <- data[c(289:296),10]
s33_hr1_coef_emis_100 <- data[c(289:296),11]
s33_hr1_homogenate_blank <- data [c(289:296), c(12:13)]
s33_hr1_homogenate_blank <- rbind(s33_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK, s33_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK.1)

#sample 34
s34_bgluc <- data [c(298:305), c(2:3)]
s34_bgluc <- rbind (s34_bgluc$b.gluc, s34_bgluc$b.gluc.1)
s34_nag <- data [c(298:305), c(4:5)]
s34_nag <- rbind (s34_nag$NAG, s34_nag$NAG.1)
s34_phos <- data [c(298:305), c(6:7)]
s34_phos <- rbind (s34_phos$Phos, s34_phos$Phos.1)
s34_hr1_coef_emis_10 <- data[c(298:305),8]
s34_hr1_coef_emis_25 <- data[c(298:305),9]
s34_hr1_coef_emis_50 <- data[c(298:305),10]
s34_hr1_coef_emis_100 <- data[c(298:305),11]
s34_hr1_homogenate_blank <- data [c(298:305), c(12:13)]
s34_hr1_homogenate_blank <- rbind(s34_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK, s34_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK.1)

#sample 35
s35_bgluc <- data [c(307:314), c(2:3)]
s35_bgluc <- rbind (s35_bgluc$b.gluc, s35_bgluc$b.gluc.1)
s35_nag <- data [c(307:314), c(4:5)]
s35_nag <- rbind (s35_nag$NAG, s35_nag$NAG.1)
s35_phos <- data [c(307:314), c(6:7)]
s35_phos <- rbind (s35_phos$Phos, s35_phos$Phos.1)
s35_hr1_coef_emis_10 <- data[c(307:314),8]
s35_hr1_coef_emis_25 <- data[c(307:314),9]
s35_hr1_coef_emis_50 <- data[c(307:314),10]
s35_hr1_coef_emis_100 <- data[c(307:314),11]
s35_hr1_homogenate_blank <- data [c(307:314), c(12:13)]
s35_hr1_homogenate_blank <- rbind(s35_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK, s35_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK.1)

#sample 36
s36_bgluc <- data [c(316:323), c(2:3)]
s36_bgluc <- rbind (s36_bgluc$b.gluc, s36_bgluc$b.gluc.1)
s36_nag <- data [c(316:323), c(4:5)]
s36_nag <- rbind (s36_nag$NAG, s36_nag$NAG.1)
s36_phos <- data [c(316:323), c(6:7)]
s36_phos <- rbind (s36_phos$Phos, s36_phos$Phos.1)
s36_hr1_coef_emis_10 <- data[c(316:323),8]
s36_hr1_coef_emis_25 <- data[c(316:323),9]
s36_hr1_coef_emis_50 <- data[c(316:323),10]
s36_hr1_coef_emis_100 <- data[c(316:323),11]
s36_hr1_homogenate_blank <- data [c(316:323), c(12:13)]
s36_hr1_homogenate_blank <- rbind(s36_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK, s36_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK.1)

#sample 37
s37_bgluc <- data [c(325:332), c(2:3)]
s37_bgluc <- rbind (s37_bgluc$b.gluc, s37_bgluc$b.gluc.1)
s37_nag <- data [c(325:332), c(4:5)]
s37_nag <- rbind (s37_nag$NAG, s37_nag$NAG.1)
s37_phos <- data [c(325:332), c(6:7)]
s37_phos <- rbind (s37_phos$Phos, s37_phos$Phos.1)
s37_hr1_coef_emis_10 <- data[c(325:332),8]
s37_hr1_coef_emis_25 <- data[c(325:332),9]
s37_hr1_coef_emis_50 <- data[c(325:332),10]
s37_hr1_coef_emis_100 <- data[c(325:332),11]
s37_hr1_homogenate_blank <- data [c(325:332), c(12:13)]
s37_hr1_homogenate_blank <- rbind(s37_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK, s37_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK.1)

#sample 38
s38_bgluc <- data [c(334:341), c(2:3)]
s38_bgluc <- rbind (s38_bgluc$b.gluc, s38_bgluc$b.gluc.1)
s38_nag <- data [c(334:341), c(4:5)]
s38_nag <- rbind (s38_nag$NAG, s38_nag$NAG.1)
s38_phos <- data [c(334:341), c(6:7)]
s38_phos <- rbind (s38_phos$Phos, s38_phos$Phos.1)
s38_hr1_coef_emis_10 <- data[c(334:341),8]
s38_hr1_coef_emis_25 <- data[c(334:341),9]
s38_hr1_coef_emis_50 <- data[c(334:341),10]
s38_hr1_coef_emis_100 <- data[c(334:341),11]
s38_hr1_homogenate_blank <- data [c(334:341), c(12:13)]
s38_hr1_homogenate_blank <- rbind(s38_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK, s38_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK.1)

#sample 39
s39_bgluc <- data [c(343:350), c(2:3)]
s39_bgluc <- rbind (s39_bgluc$b.gluc, s39_bgluc$b.gluc.1)
s39_nag <- data [c(343:350), c(4:5)]
s39_nag <- rbind (s39_nag$NAG, s39_nag$NAG.1)
s39_phos <- data [c(343:350), c(6:7)]
s39_phos <- rbind (s39_phos$Phos, s39_phos$Phos.1)
s39_hr1_coef_emis_10 <- data[c(343:350),8]
s39_hr1_coef_emis_25 <- data[c(343:350),9]
s39_hr1_coef_emis_50 <- data[c(343:350),10]
s39_hr1_coef_emis_100 <- data[c(343:350),11]
s39_hr1_homogenate_blank <- data [c(343:350), c(12:13)]
s39_hr1_homogenate_blank <- rbind(s39_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK, s39_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK.1)

#sample 40
s40_bgluc <- data [c(352:359), c(2:3)]
s40_bgluc <- rbind (s40_bgluc$b.gluc, s40_bgluc$b.gluc.1)
s40_nag <- data [c(352:359), c(4:5)]
s40_nag <- rbind (s40_nag$NAG, s40_nag$NAG.1)
s40_phos <- data [c(352:359), c(6:7)]
s40_phos <- rbind (s40_phos$Phos, s40_phos$Phos.1)
s40_hr1_coef_emis_10 <- data[c(352:359),8]
s40_hr1_coef_emis_25 <- data[c(352:359),9]
s40_hr1_coef_emis_50 <- data[c(352:359),10]
s40_hr1_coef_emis_100 <- data[c(352:359),11]
s40_hr1_homogenate_blank <- data [c(352:359), c(12:13)]
s40_hr1_homogenate_blank <- rbind(s40_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK, s40_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK.1)

#control 1
c1_bgluc <- data [c(361:368), c(2:3)]
c1_bgluc <- rbind (c1_bgluc$b.gluc, c1_bgluc$b.gluc.1)
c1_nag <- data [c(361:368), c(4:5)]
c1_nag <- rbind (c1_nag$NAG, c1_nag$NAG.1)
c1_phos <- data [c(361:368), c(6:7)]
c1_phos <- rbind (c1_phos$Phos, c1_phos$Phos.1)
c1_hr1_coef_emis_10 <- data[c(361:368),8]
c1_hr1_coef_emis_25 <- data[c(361:368),9]
c1_hr1_coef_emis_50 <- data[c(361:368),10]
c1_hr1_coef_emis_100 <- data[c(361:368),11]
c1_hr1_homogenate_blank <- data [c(361:368), c(12:13)]
...
#control 2
c2_bgluc <- data [c(370:377), c(2:3)]
c2_bgluc <- rbind (c2_bgluc$b.gluc, c2_bgluc$b.gluc.1)
c2_nag <- data [c(370:377), c(4:5)]
c2_nag <- rbind (c2_nag$NAG, c2_nag$NAG.1)
c2_phos <- data [c(370:377), c(6:7)]
c2_phos <- rbind (c2_phos$Phos, c2_phos$Phos.1)
c2_hr1_coef_emis_10 <- data[c(370:377),8]
c2_hr1_coef_emis_25 <- data[c(370:377),9]
c2_hr1_coef_emis_50 <- data[c(370:377),10]
c2_hr1_coef_emis_100 <- data[c(370:377),11]
c2_hr1_homogenate_blank <- data [c(370:377), c(12:13)]
...
#control 3
c3_bgluc <- data [c(379:386), c(2:3)]
c3_bgluc <- rbind (c3_bgluc$b.gluc, c3_bgluc$b.gluc.1)
c3_nag <- data [c(379:386), c(4:5)]
c3_nag <- rbind (c3_nag$NAG, c3_nag$NAG.1)
c3_phos <- data [c(379:386), c(6:7)]
c3_phos <- rbind (c3_phos$Phos, c3_phos$Phos.1)
c3_hr1_coef_emis_10 <- data[c(379:386),8]
c3_hr1_coef_emis_25 <- data[c(379:386),9]
c3_hr1_coef_emis_50 <- data[c(379:386),10]
c3_hr1_coef_emis_100 <- data[c(379:386),11]
c3_hr1_homogenate_blank <- data [c(379:386), c(12:13)]
...
#control 4
c4_bgluc <- data [c(388:395), c(2:3)]
c4_bgluc <- rbind (c4_bgluc$b.gluc, c4_bgluc$b.gluc.1)
c4_nag <- data [c(388:395), c(4:5)]
c4_nag <- rbind (c4_nag$NAG, c4_nag$NAG.1)
c4_phos <- data [c(388:395), c(6:7)]
c4_phos <- rbind (c4_phos$Phos, c4_phos$Phos.1)
c4_hr1_coef_emis_10 <- data[c(388:395),8]
c4_hr1_coef_emis_25 <- data[c(388:395),9]
c4_hr1_coef_emis_50 <- data[c(388:395),10]
c4_hr1_coef_emis_100 <- data[c(388:395),11]
c4_hr1_homogenate_blank <- data [c(388:395), c(12:13)]
...
#control 5
c5_bgluc <- data [c(397:404), c(2:3)]
c5_bgluc <- rbind (c5_bgluc$b.gluc, c5_bgluc$b.gluc.1)
c5_nag <- data [c(397:404), c(4:5)]
c5_nag <- rbind (c5_nag$NAG, c5_nag$NAG.1)
c5_phos <- data [c(397:404), c(6:7)]
c5_phos <- rbind (c5_phos$Phos, c5_phos$Phos.1)
c5_hr1_coef_emis_10 <- data[c(397:404),8]
c5_hr1_coef_emis_25 <- data[c(397:404),9]
c5_hr1_coef_emis_50 <- data[c(397:404),10]
c5_hr1_coef_emis_100 <- data[c(397:404),11]
c5_hr1_homogenate_blank <- data [c(397:404), c(12:13)]
c5_hr1_homogenate_blank <- rbind(c5_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK, c5_hr1_homogenate_blank$X1.hr.HOMOGENATE.BLANK.1)
...
#sample 31
s31_bgluc_final <- remove_outliers(s31_bgluc)
s31_bgluc_average <- mean(s31_bgluc_final)

s31_nag_final <- remove_outliers(s31_nag)
s31_nag_average <- mean(s31_nag_final)

s31_phos_final <- remove_outliers(s31_phos)
s31_phos_average <- mean(s31_phos_final)

s31_hr1_coef_emis_10_final <- remove_outliers(s31_hr1_coef_emis_10)
s31_hr1_coef_emis_10_average <- mean(s31_hr1_coef_emis_10_final)

s31_hr1_coef_emis_25_final <- remove_outliers(s31_hr1_coef_emis_25)
s31_hr1_coef_emis_25_average <- mean(s31_hr1_coef_emis_25_final)

s31_hr1_coef_emis_50_final <- remove_outliers(s31_hr1_coef_emis_50)
s31_hr1_coef_emis_50_average <- mean(s31_hr1_coef_emis_50_final)

s31_hr1_coef_emis_100_final <- remove_outliers(s31_hr1_coef_emis_100)
s31_hr1_coef_emis_100_average <- mean(s31_hr1_coef_emis_100_final)

s31_hr1_homogenate_blank_final <- remove_outliers(s31_hr1_homogenate_blank)
s31_hr1_homogenate_blank_average <- mean(s31_hr1_homogenate_blank_final)

#sample 32
s32_bgluc_final <- remove_outliers(s32_bgluc)
s32_bgluc_average <- mean(s32_bgluc_final)

s32_nag_final <- remove_outliers(s32_nag)
s32_nag_average <- mean(s32_nag_final)

s32_phos_final <- remove_outliers(s32_phos)
s32_phos_average <- mean(s32_phos_final)

s32_hr1_coef_emis_10_final <- remove_outliers(s32_hr1_coef_emis_10)
s32_hr1_coef_emis_10_average <- mean(s32_hr1_coef_emis_10_final)

s32_hr1_coef_emis_25_final <- remove_outliers(s32_hr1_coef_emis_25)
s32_hr1_coef_emis_25_average <- mean(s32_hr1_coef_emis_25_final)

s32_hr1_coef_emis_50_final <- remove_outliers(s32_hr1_coef_emis_50)
s32_hr1_coef_emis_50_average <- mean(s32_hr1_coef_emis_50_final)

s32_hr1_coef_emis_100_final <- remove_outliers(s32_hr1_coef_emis_100)
s32_hr1_coef_emis_100_average <- mean(s32_hr1_coef_emis_100_final)

s32_hr1_homogenate_blank_final <- remove_outliers(s32_hr1_homogenate_blank)
s32_hr1_homogenate_blank_average <- mean(s32_hr1_homogenate_blank_final)

#sample 33
s33_bgluc_final <- remove_outliers(s33_bgluc)
s33_bgluc_average <- mean(s33_bgluc_final)

s33_nag_final <- remove_outliers(s33_nag)
s33_nag_average <- mean(s33_nag_final)

s33_phos_final <- remove_outliers(s33_phos)
s33_phos_average <- mean(s33_phos_final)

s33_hr1_coef_emis_10_final <- remove_outliers(s33_hr1_coef_emis_10)
s33_hr1_coef_emis_10_average <- mean(s33_hr1_coef_emis_10_final)

s33_hr1_coef_emis_25_final <- remove_outliers(s33_hr1_coef_emis_25)
s33_hr1_coef_emis_25_average <- mean(s33_hr1_coef_emis_25_final)

s33_hr1_coef_emis_50_final <- remove_outliers(s33_hr1_coef_emis_50)
s33_hr1_coef_emis_50_average <- mean(s33_hr1_coef_emis_50_final)

s33_hr1_coef_emis_100_final <- remove_outliers(s33_hr1_coef_emis_100)
s33_hr1_coef_emis_100_average <- mean(s33_hr1_coef_emis_100_final)

s33_hr1_homogenate_blank_final <- remove_outliers(s33_hr1_homogenate_blank)
s33_hr1_homogenate_blank_average <- mean(s33_hr1_homogenate_blank_final)

#sample 34
s34_bgluc_final <- remove_outliers(s34_bgluc)
s34_bgluc_average <- mean(s34_bgluc_final)

s34_nag_final <- remove_outliers(s34_nag)
s34_nag_average <- mean(s34_nag_final)

s34_phos_final <- remove_outliers(s34_phos)
s34_phos_average <- mean(s34_phos_final)

s34_hr1_coef_emis_10_final <- remove_outliers(s34_hr1_coef_emis_10)
s34_hr1_coef_emis_10_average <- mean(s34_hr1_coef_emis_10_final)

s34_hr1_coef_emis_25_final <- remove_outliers(s34_hr1_coef_emis_25)
s34_hr1_coef_emis_25_average <- mean(s34_hr1_coef_emis_25_final)

s34_hr1_coef_emis_50_final <- remove_outliers(s34_hr1_coef_emis_50)
s34_hr1_coef_emis_50_average <- mean(s34_hr1_coef_emis_50_final)

s34_hr1_coef_emis_100_final <- remove_outliers(s34_hr1_coef_emis_100)
s34_hr1_coef_emis_100_average <- mean(s34_hr1_coef_emis_100_final)

s34_hr1_homogenate_blank_final <- remove_outliers(s34_hr1_homogenate_blank)
s34_hr1_homogenate_blank_average <- mean(s34_hr1_homogenate_blank_final)

#sample 35
s35_bgluc_final <- remove_outliers(s35_bgluc)
s35_bgluc_average <- mean(s35_bgluc_final)

s35_nag_final <- remove_outliers(s35_nag)
s35_nag_average <- mean(s35_nag_final)

s35_phos_final <- remove_outliers(s35_phos)
s35_phos_average <- mean(s35_phos_final)

s35_hr1_coef_emis_10_final <- remove_outliers(s35_hr1_coef_emis_10)
s35_hr1_coef_emis_10_average <- mean(s35_hr1_coef_emis_10_final)

s35_hr1_coef_emis_25_final <- remove_outliers(s35_hr1_coef_emis_25)
s35_hr1_coef_emis_25_average <- mean(s35_hr1_coef_emis_25_final)

s35_hr1_coef_emis_50_final <- remove_outliers(s35_hr1_coef_emis_50)
s35_hr1_coef_emis_50_average <- mean(s35_hr1_coef_emis_50_final)

s35_hr1_coef_emis_100_final <- remove_outliers(s35_hr1_coef_emis_100)
s35_hr1_coef_emis_100_average <- mean(s35_hr1_coef_emis_100_final)

s35_hr1_homogenate_blank_final <- remove_outliers(s35_hr1_homogenate_blank)
s35_hr1_homogenate_blank_average <- mean(s35_hr1_homogenate_blank_final)

#sample 36
s36_bgluc_final <- remove_outliers(s36_bgluc)
s36_bgluc_average <- mean(s36_bgluc_final)

s36_nag_final <- remove_outliers(s36_nag)
s36_nag_average <- mean(s36_nag_final)

s36_phos_final <- remove_outliers(s36_phos)
s36_phos_average <- mean(s36_phos_final)

s36_hr1_coef_emis_10_final <- remove_outliers(s36_hr1_coef_emis_10)
s36_hr1_coef_emis_10_average <- mean(s36_hr1_coef_emis_10_final)

s36_hr1_coef_emis_25_final <- remove_outliers(s36_hr1_coef_emis_25)
s36_hr1_coef_emis_25_average <- mean(s36_hr1_coef_emis_25_final)

s36_hr1_coef_emis_50_final <- remove_outliers(s36_hr1_coef_emis_50)
s36_hr1_coef_emis_50_average <- mean(s36_hr1_coef_emis_50_final)

s36_hr1_coef_emis_100_final <- remove_outliers(s36_hr1_coef_emis_100)
s36_hr1_coef_emis_100_average <- mean(s36_hr1_coef_emis_100_final)

s36_hr1_homogenate_blank_final <- remove_outliers(s36_hr1_homogenate_blank)
s36_hr1_homogenate_blank_average <- mean(s36_hr1_homogenate_blank_final)

#sample 37
s37_bgluc_final <- remove_outliers(s37_bgluc)
s37_bgluc_average <- mean(s37_bgluc_final)

s37_nag_final <- remove_outliers(s37_nag)
s37_nag_average <- mean(s37_nag_final)

s37_phos_final <- remove_outliers(s37_phos)
s37_phos_average <- mean(s37_phos_final)

s37_hr1_coef_emis_10_final <- remove_outliers(s37_hr1_coef_emis_10)
s37_hr1_coef_emis_10_average <- mean(s37_hr1_coef_emis_10_final)

s37_hr1_coef_emis_25_final <- remove_outliers(s37_hr1_coef_emis_25)
s37_hr1_coef_emis_25_average <- mean(s37_hr1_coef_emis_25_final)

s37_hr1_coef_emis_50_final <- remove_outliers(s37_hr1_coef_emis_50)
s37_hr1_coef_emis_50_average <- mean(s37_hr1_coef_emis_50_final)

s37_hr1_coef_emis_100_final <- remove_outliers(s37_hr1_coef_emis_100)
s37_hr1_coef_emis_100_average <- mean(s37_hr1_coef_emis_100_final)

s37_hr1_homogenate_blank_final <- remove_outliers(s37_hr1_homogenate_blank)
s37_hr1_homogenate_blank_average <- mean(s37_hr1_homogenate_blank_final)

#sample 38
s38_bgluc_final <- remove_outliers(s38_bgluc)
s38_bgluc_average <- mean(s38_bgluc_final)

s38_nag_final <- remove_outliers(s38_nag)
s38_nag_average <- mean(s38_nag_final)

s38_phos_final <- remove_outliers(s38_phos)
s38_phos_average <- mean(s38_phos_final)

s38_hr1_coef_emis_10_final <- remove_outliers(s38_hr1_coef_emis_10)
s38_hr1_coef_emis_10_average <- mean(s38_hr1_coef_emis_10_final)

s38_hr1_coef_emis_25_final <- remove_outliers(s38_hr1_coef_emis_25)
s38_hr1_coef_emis_25_average <- mean(s38_hr1_coef_emis_25_final)

s38_hr1_coef_emis_50_final <- remove_outliers(s38_hr1_coef_emis_50)
s38_hr1_coef_emis_50_average <- mean(s38_hr1_coef_emis_50_final)

s38_hr1_coef_emis_100_final <- remove_outliers(s38_hr1_coef_emis_100)
s38_hr1_coef_emis_100_average <- mean(s38_hr1_coef_emis_100_final)

s38_hr1_homogenate_blank_final <- remove_outliers(s38_hr1_homogenate_blank)
s38_hr1_homogenate_blank_average <- mean(s38_hr1_homogenate_blank_final)

#sample 39
s39_bgluc_final <- remove_outliers(s39_bgluc)
s39_bgluc_average <- mean(s39_bgluc_final)

s39_nag_final <- remove_outliers(s39_nag)
s39_nag_average <- mean(s39_nag_final)

s39_phos_final <- remove_outliers(s39_phos)
s39_phos_average <- mean(s39_phos_final)

s39_hr1_coef_emis_10_final <- remove_outliers(s39_hr1_coef_emis_10)
s39_hr1_coef_emis_10_average <- mean(s39_hr1_coef_emis_10_final)

s39_hr1_coef_emis_25_final <- remove_outliers(s39_hr1_coef_emis_25)
s39_hr1_coef_emis_25_average <- mean(s39_hr1_coef_emis_25_final)

s39_hr1_coef_emis_50_final <- remove_outliers(s39_hr1_coef_emis_50)
s39_hr1_coef_emis_50_average <- mean(s39_hr1_coef_emis_50_final)

s39_hr1_coef_emis_100_final <- remove_outliers(s39_hr1_coef_emis_100)
s39_hr1_coef_emis_100_average <- mean(s39_hr1_coef_emis_100_final)

s39_hr1_homogenate_blank_final <- remove_outliers(s39_hr1_homogenate_blank)
s39_hr1_homogenate_blank_average <- mean(s39_hr1_homogenate_blank_final)

#sample 40
s40_bgluc_final <- remove_outliers(s40_bgluc)
s40_bgluc_average <- mean(s40_bgluc_final)

s40_nag_final <- remove_outliers(s40_nag)
s40_nag_average <- mean(s40_nag_final)

s40_phos_final <- remove_outliers(s40_phos)
s40_phos_average <- mean(s40_phos_final)

s40_hr1_coef_emis_10_final <- remove_outliers(s40_hr1_coef_emis_10)
s40_hr1_coef_emis_10_average <- mean(s40_hr1_coef_emis_10_final)

s40_hr1_coef_emis_25_final <- remove_outliers(s40_hr1_coef_emis_25)
s40_hr1_coef_emis_25_average <- mean(s40_hr1_coef_emis_25_final)

s40_hr1_coef_emis_50_final <- remove_outliers(s40_hr1_coef_emis_50)
s40_hr1_coef_emis_50_average <- mean(s40_hr1_coef_emis_50_final)

s40_hr1_coef_emis_100_final <- remove_outliers(s40_hr1_coef_emis_100)
s40_hr1_coef_emis_100_average <- mean(s40_hr1_coef_emis_100_final)

s40_hr1_homogenate_blank_final <- remove_outliers(s40_hr1_homogenate_blank)
s40_hr1_homogenate_blank_average <- mean(s40_hr1_homogenate_blank_final)
...
#control 5
c5_bgluc_final <- remove_outliers(c5_bgluc)
c5_bgluc_average <- mean(c5_bgluc_final)

c5_nag_final <- remove_outliers(c5_nag)
c5_nag_average <- mean(c5_nag_final)

c5_phos_final <- remove_outliers(c5_phos)
c5_phos_average <- mean(c5_phos_final)

c5_hr1_coef_emis_10_final <- remove_outliers(c5_hr1_coef_emis_10)
c5_hr1_coef_emis_10_average <- mean(c5_hr1_coef_emis_10_final)

c5_hr1_coef_emis_25_final <- remove_outliers(c5_hr1_coef_emis_25)
c5_hr1_coef_emis_25_average <- mean(c5_hr1_coef_emis_25_final)

c5_hr1_coef_emis_50_final <- remove_outliers(c5_hr1_coef_emis_50)
c5_hr1_coef_emis_50_average <- mean(c5_hr1_coef_emis_50_final)

c5_hr1_coef_emis_100_final <- remove_outliers(c5_hr1_coef_emis_100)
c5_hr1_coef_emis_100_average <- mean(c5_hr1_coef_emis_100_final)

c5_hr1_homogenate_blank_final <- remove_outliers(c5_hr1_homogenate_blank)
c5_hr1_homogenate_blank_average <- mean(c5_hr1_homogenate_blank_final)
#################################################################################
#calculating averages of the controls for all enzymes, MUB standards and blank
#################################################################################

bgluc_control_final <- rbind(c1_bgluc_average,c2_bgluc_average,c3_bgluc_average, c4_bgluc_average,c5_bgluc_average)
bgluc_control_average <- mean(bgluc_control_final)

nag_control_final <- rbind(c1_nag_average,c2_nag_average, c3_nag_average, c4_nag_average, c5_nag_average)
nag_control_average <- mean(nag_control_final)

phos_control_final <- rbind(c1_phos_average,c2_phos_average, c3_phos_average, c4_phos_average, c5_phos_average)
...
hr1_coef_emis_10_control_final <- rbind(c1_hr1_coef_emis_10_average,c2_hr1_coef_emis_10_average, c3_hr1_coef_emis_10_average
                                        ,c4_hr1_coef_emis_10_average, c5_hr1_coef_emis_10_average)
...
hr1_coef_emis_25_control_final <- rbind(c1_hr1_coef_emis_25_average,c2_hr1_coef_emis_25_average,c3_hr1_coef_emis_25_average,
                                        c4_hr1_coef_emis_25_average, c5_hr1_coef_emis_25_average)
...
hr1_coef_emis_50_control_final <- rbind(c1_hr1_coef_emis_50_average,c2_hr1_coef_emis_50_average,c3_hr1_coef_emis_50_average,
                                        c4_hr1_coef_emis_50_average, c5_hr1_coef_emis_50_average)
...
hr1_coef_emis_100_control_final <- rbind(c1_hr1_coef_emis_100_average,c2_hr1_coef_emis_100_average,c3_hr1_coef_emis_100_average,
                                         c4_hr1_coef_emis_100_average, c5_hr1_coef_emis_100_average)
...
hr1_homogenate_blank_control_final <- rbind (c1_hr1_homogenate_blank_average, c2_hr1_homogenate_blank_average,c3_hr1_homogenate_blank_average
                                             , c4_hr1_homogenate_blank_average, c5_hr1_homogenate_blank_average)
...
slope_y_s31 <- rbind(s31_hr1_coef_emis_10_average, s31_hr1_coef_emis_25_average,
                     s31_hr1_coef_emis_50_average, s31_hr1_coef_emis_100_average)
slope_y_s32 <- rbind(s32_hr1_coef_emis_10_average, s32_hr1_coef_emis_25_average,
                     s32_hr1_coef_emis_50_average, s32_hr1_coef_emis_100_average)
slope_y_s33 <- rbind(s33_hr1_coef_emis_10_average, s33_hr1_coef_emis_25_average,
                     s33_hr1_coef_emis_50_average, s33_hr1_coef_emis_100_average)
slope_y_s34 <- rbind(s34_hr1_coef_emis_10_average, s34_hr1_coef_emis_25_average,
                     s34_hr1_coef_emis_50_average, s34_hr1_coef_emis_100_average)
slope_y_s35 <- rbind(s35_hr1_coef_emis_10_average, s35_hr1_coef_emis_25_average,
                     s35_hr1_coef_emis_50_average, s35_hr1_coef_emis_100_average)
slope_y_s36 <- rbind(s36_hr1_coef_emis_10_average, s36_hr1_coef_emis_25_average,
                     s36_hr1_coef_emis_50_average, s36_hr1_coef_emis_100_average)
slope_y_s37 <- rbind(s37_hr1_coef_emis_10_average, s37_hr1_coef_emis_25_average,
                     s37_hr1_coef_emis_50_average, s37_hr1_coef_emis_100_average)
slope_y_s38 <- rbind(s38_hr1_coef_emis_10_average, s38_hr1_coef_emis_25_average,
                     s38_hr1_coef_emis_50_average, s38_hr1_coef_emis_100_average)
slope_y_s39 <- rbind(s39_hr1_coef_emis_10_average, s39_hr1_coef_emis_25_average,
                     s39_hr1_coef_emis_50_average, s39_hr1_coef_emis_100_average)
slope_y_s40 <- rbind(s40_hr1_coef_emis_10_average, s40_hr1_coef_emis_25_average,
                     s40_hr1_coef_emis_50_average, s40_hr1_coef_emis_100_average)
...
s31_fit.lm <- lm(slope_y_s31 ~ slope_x)
s31_slope <- coef(s31_fit.lm)[[2]]

s32_fit.lm <- lm(slope_y_s32 ~ slope_x)
s32_slope <- coef(s32_fit.lm)[[2]]

s33_fit.lm <- lm(slope_y_s33 ~ slope_x)
s33_slope <- coef(s33_fit.lm)[[2]]

s34_fit.lm <- lm(slope_y_s34 ~ slope_x)
s34_slope <- coef(s34_fit.lm)[[2]]

s35_fit.lm <- lm(slope_y_s35 ~ slope_x)
s35_slope <- coef(s35_fit.lm)[[2]]

s36_fit.lm <- lm(slope_y_s36 ~ slope_x)
s36_slope <- coef(s36_fit.lm)[[2]]

s37_fit.lm <- lm(slope_y_s37 ~ slope_x)
s37_slope <- coef(s37_fit.lm)[[2]]

s38_fit.lm <- lm(slope_y_s38 ~ slope_x)
s38_slope <- coef(s38_fit.lm)[[2]]

s39_fit.lm <- lm(slope_y_s39 ~ slope_x)
s39_slope <- coef(s39_fit.lm)[[2]]

s40_fit.lm <- lm(slope_y_s40 ~ slope_x)
s40_slope <- coef(s40_fit.lm)[[2]]
...
s31_qc <- s31_slope/ buffer_slope
s32_qc <- s32_slope/ buffer_slope
s33_qc <- s33_slope/ buffer_slope
s34_qc <- s34_slope/ buffer_slope
s35_qc <- s35_slope/ buffer_slope
s36_qc <- s36_slope/ buffer_slope
s37_qc <- s37_slope/ buffer_slope
s38_qc <- s38_slope/ buffer_slope
s39_qc <- s39_slope/ buffer_slope
s40_qc <- s40_slope/ buffer_slope
...
s31_ec <-s31_slope/0.25
s32_ec <-s32_slope/0.25
s33_ec <-s33_slope/0.25
s34_ec <-s34_slope/0.25
s35_ec <-s35_slope/0.25
s36_ec <-s36_slope/0.25
s37_ec <-s37_slope/0.25
s38_ec <-s38_slope/0.25
s39_ec <-s39_slope/0.25
s40_ec <-s40_slope/0.25
...
s30_bgluc_flour <- ((s30_bgluc_average - s30_hr1_homogenate_blank_average)/ s30_qc) - 
  (bgluc_control_average - hr1_homogenate_blank_control_average)
s31_bgluc_flour <- ((s31_bgluc_average - s31_hr1_homogenate_blank_average)/ s31_qc) - 
  (bgluc_control_average - hr1_homogenate_blank_control_average)
s32_bgluc_flour <- ((s32_bgluc_average - s32_hr1_homogenate_blank_average)/ s32_qc) - 
  (bgluc_control_average - hr1_homogenate_blank_control_average)
s33_bgluc_flour <- ((s33_bgluc_average - s33_hr1_homogenate_blank_average)/ s33_qc) - 
  (bgluc_control_average - hr1_homogenate_blank_control_average)
s34_bgluc_flour <- ((s34_bgluc_average - s34_hr1_homogenate_blank_average)/ s34_qc) - 
  (bgluc_control_average - hr1_homogenate_blank_control_average)
s35_bgluc_flour <- ((s35_bgluc_average - s35_hr1_homogenate_blank_average)/ s35_qc) - 
  (bgluc_control_average - hr1_homogenate_blank_control_average)
s36_bgluc_flour <- ((s36_bgluc_average - s36_hr1_homogenate_blank_average)/ s36_qc) - 
  (bgluc_control_average - hr1_homogenate_blank_control_average)
s37_bgluc_flour <- ((s37_bgluc_average - s37_hr1_homogenate_blank_average)/ s37_qc) - 
  (bgluc_control_average - hr1_homogenate_blank_control_average)
s38_bgluc_flour <- ((s38_bgluc_average - s38_hr1_homogenate_blank_average)/ s38_qc) - 
  (bgluc_control_average - hr1_homogenate_blank_control_average)
s39_bgluc_flour <- ((s39_bgluc_average - s39_hr1_homogenate_blank_average)/ s39_qc) - 
  (bgluc_control_average - hr1_homogenate_blank_control_average)
s40_bgluc_flour <- ((s40_bgluc_average - s40_hr1_homogenate_blank_average)/ s40_qc) - 
  (bgluc_control_average - hr1_homogenate_blank_control_average)
...
s30_nag_flour <- ((s30_nag_average - s30_hr1_homogenate_blank_average)/ s30_qc) - 
  (nag_control_average - hr1_homogenate_blank_control_average)
s31_nag_flour <- ((s31_nag_average - s31_hr1_homogenate_blank_average)/ s31_qc) - 
  (nag_control_average - hr1_homogenate_blank_control_average)
s32_nag_flour <- ((s32_nag_average - s32_hr1_homogenate_blank_average)/ s32_qc) - 
  (nag_control_average - hr1_homogenate_blank_control_average)
s33_nag_flour <- ((s33_nag_average - s33_hr1_homogenate_blank_average)/ s33_qc) - 
  (nag_control_average - hr1_homogenate_blank_control_average)
s34_nag_flour <- ((s34_nag_average - s34_hr1_homogenate_blank_average)/ s34_qc) - 
  (nag_control_average - hr1_homogenate_blank_control_average)
s35_nag_flour <- ((s35_nag_average - s35_hr1_homogenate_blank_average)/ s35_qc) - 
  (nag_control_average - hr1_homogenate_blank_control_average)
s36_nag_flour <- ((s36_nag_average - s36_hr1_homogenate_blank_average)/ s36_qc) - 
  (nag_control_average - hr1_homogenate_blank_control_average)
s37_nag_flour <- ((s37_nag_average - s37_hr1_homogenate_blank_average)/ s37_qc) - 
  (nag_control_average - hr1_homogenate_blank_control_average)
s38_nag_flour <- ((s38_nag_average - s38_hr1_homogenate_blank_average)/ s38_qc) - 
  (nag_control_average - hr1_homogenate_blank_control_average)
s39_nag_flour <- ((s39_nag_average - s39_hr1_homogenate_blank_average)/ s39_qc) - 
  (nag_control_average - hr1_homogenate_blank_control_average)
s40_nag_flour <- ((s40_nag_average - s40_hr1_homogenate_blank_average)/ s40_qc) - 
  (nag_control_average - hr1_homogenate_blank_control_average)
...
s30_phos_flour <- ((s30_phos_average - s30_hr1_homogenate_blank_average)/ s30_qc) - 
  (phos_control_average - hr1_homogenate_blank_control_average)
s31_phos_flour <- ((s31_phos_average - s31_hr1_homogenate_blank_average)/ s31_qc) - 
  (phos_control_average - hr1_homogenate_blank_control_average)
s32_phos_flour <- ((s32_phos_average - s32_hr1_homogenate_blank_average)/ s32_qc) - 
  (phos_control_average - hr1_homogenate_blank_control_average)
s33_phos_flour <- ((s33_phos_average - s33_hr1_homogenate_blank_average)/ s33_qc) - 
  (phos_control_average - hr1_homogenate_blank_control_average)
s34_phos_flour <- ((s34_phos_average - s34_hr1_homogenate_blank_average)/ s34_qc) - 
  (phos_control_average - hr1_homogenate_blank_control_average)
s35_phos_flour <- ((s35_phos_average - s35_hr1_homogenate_blank_average)/ s35_qc) - 
  (phos_control_average - hr1_homogenate_blank_control_average)
s36_phos_flour <- ((s36_phos_average - s36_hr1_homogenate_blank_average)/ s36_qc) - 
  (phos_control_average - hr1_homogenate_blank_control_average)
s37_phos_flour <- ((s37_phos_average - s37_hr1_homogenate_blank_average)/ s37_qc) - 
  (phos_control_average - hr1_homogenate_blank_control_average)
s38_phos_flour <- ((s38_phos_average - s38_hr1_homogenate_blank_average)/ s38_qc) - 
  (phos_control_average - hr1_homogenate_blank_control_average)
s39_phos_flour <- ((s39_phos_average - s39_hr1_homogenate_blank_average)/ s39_qc) - 
  (phos_control_average - hr1_homogenate_blank_control_average)
s40_phos_flour <- ((s40_phos_average - s40_hr1_homogenate_blank_average)/ s40_qc) - 
  (phos_control_average - hr1_homogenate_blank_control_average)
...
s31_bgluc_activity <- (100*s31_bgluc_flour) / (s31_ec*0.2*data[31,15]* data[31,16])
s32_bgluc_activity <- (100*s32_bgluc_flour) / (s32_ec*0.2*data[32,15]* data[32,16])
s33_bgluc_activity <- (100*s33_bgluc_flour) / (s33_ec*0.2*data[33,15]* data[33,16])
s34_bgluc_activity <- (100*s34_bgluc_flour) / (s34_ec*0.2*data[34,15]* data[34,16])
s35_bgluc_activity <- (100*s35_bgluc_flour) / (s35_ec*0.2*data[35,15]* data[35,16])
s36_bgluc_activity <- (100*s36_bgluc_flour) / (s36_ec*0.2*data[36,15]* data[36,16])
s37_bgluc_activity <- (100*s37_bgluc_flour) / (s37_ec*0.2*data[37,15]* data[37,16])
s38_bgluc_activity <- (100*s38_bgluc_flour) / (s38_ec*0.2*data[38,15]* data[38,16])
s39_bgluc_activity <- (100*s39_bgluc_flour) / (s39_ec*0.2*data[39,15]* data[39,16])
s40_bgluc_activity <- (100*s40_bgluc_flour) / (s40_ec*0.2*data[40,15]* data[40,16])
...
s31_nag_activity <- (100*s31_nag_flour) / (s31_ec*0.2*data[31,15]* data[31,16])
s32_nag_activity <- (100*s32_nag_flour) / (s32_ec*0.2*data[32,15]* data[32,16])
s33_nag_activity <- (100*s33_nag_flour) / (s33_ec*0.2*data[33,15]* data[33,16])
s34_nag_activity <- (100*s34_nag_flour) / (s34_ec*0.2*data[34,15]* data[34,16])
s35_nag_activity <- (100*s35_nag_flour) / (s35_ec*0.2*data[35,15]* data[35,16])
s36_nag_activity <- (100*s36_nag_flour) / (s36_ec*0.2*data[36,15]* data[36,16])
s37_nag_activity <- (100*s37_nag_flour) / (s37_ec*0.2*data[37,15]* data[37,16])
s38_nag_activity <- (100*s38_nag_flour) / (s38_ec*0.2*data[38,15]* data[38,16])
s39_nag_activity <- (100*s39_nag_flour) / (s39_ec*0.2*data[39,15]* data[39,16])
s40_nag_activity <- (100*s40_nag_flour) / (s40_ec*0.2*data[40,15]* data[40,16])
...
s31_phos_activity <- (100*s31_phos_flour) / (s31_ec*0.2*data[31,15]* data[31,16])
s32_phos_activity <- (100*s32_phos_flour) / (s32_ec*0.2*data[32,15]* data[32,16])
s33_phos_activity <- (100*s33_phos_flour) / (s33_ec*0.2*data[33,15]* data[33,16])
s34_phos_activity <- (100*s34_phos_flour) / (s34_ec*0.2*data[34,15]* data[34,16])
s35_phos_activity <- (100*s35_phos_flour) / (s35_ec*0.2*data[35,15]* data[35,16])
s36_phos_activity <- (100*s36_phos_flour) / (s36_ec*0.2*data[36,15]* data[36,16])
s37_phos_activity <- (100*s37_phos_flour) / (s37_ec*0.2*data[37,15]* data[37,16])
s38_phos_activity <- (100*s38_phos_flour) / (s38_ec*0.2*data[38,15]* data[38,16])
s39_phos_activity <- (100*s39_phos_flour) / (s39_ec*0.2*data[39,15]* data[39,16])
s40_phos_activity <- (100*s40_phos_flour) / (s40_ec*0.2*data[40,15]* data[40,16])
...
write.csv(final_results, file = "C:/Users/ayush/Dropbox/Ayush/enzyme study/jacob/R/result/JPRER3_12-32-19.1.csv")
